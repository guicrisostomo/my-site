export default {
  translations: {
    ...
    home: {
      about: {
        title: "Sobre mim",
        text: "Atualmente, sou formado em Analise e Desenvolvimento de Sistemas (ADS) pela FATEC e desenvolvedor Front-end pela PA Informática. Quanto a minha vida profissional, atuo com React, juntamente com ferramentas como TypeScript, Vite, Tailwind CSS, Shadcn, Redux, React Forms, Zod. Já atuei na criação de sites conforme figma; visualização e envio imagens e outros documentos para API; elaboração gráficos por meio dos dados obtidos pelo back-end; criação sessões utilizando cookies com padrão JWT; envio tokens de autorização para a API. Sempre adorei desafios e solucionar problemas (coisas pelas quais me fizeram gostar e muito da área de TI)! Quanto a minha vida particular, adoro codar na horas vagas, jogar no console/PC, assistir séries e conversar com amigos! Sou bom em trabalhar em equipe e sou proativo!",
      },
